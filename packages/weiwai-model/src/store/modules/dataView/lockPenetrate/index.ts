...
import { lockPenetrateState } from '@services/types/dataShow/lockPenetrate'
...
export const lockPenetrateStore = defineStore('lockPenetrate', {
  state: (): lockPenetrateState => ({
    treeList: [],
    hasParent: false,
    checkedKeys: [],
    expandedKeys: [],
  ...
  actions: {
   ...
   async inquire(val?: any) {
    ...
    const res = await vlaData.penerateDataLockGetPenarateListPost({
      ...val,
